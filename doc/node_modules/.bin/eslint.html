...
<p>Otherwise, call the CLI.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">const</span> exitCode = <span class="hljs-keyword">await</span> <span class="hljs-built_in">require</span>(<span class="hljs-string">"../lib/cli"</span>).execute(
        process.argv,
